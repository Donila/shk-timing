...
const messages = {
  'en': {
    ...
    adminDelete: 'Delete',
    adminStatusWaiting: 'Waiting approve',
    adminStatusGranted: 'Access granted',
    adminTabUsers: 'Users',
    adminTabEvents: 'Events',
    adminEventsTitle: 'Events',
    adminFilterByUsername: 'Filter by username',
    adminFilterByEventType: 'Filter by event type',
    adminFilterFrom: 'From',
    adminFilterTo: 'To',
    adminApply: 'Apply',
    adminReset: 'Reset',
    adminColTimestamp: 'Timestamp',
    adminColUsername: 'Username',
    adminColEventType: 'Event type',
    adminColParams: 'Params',
    adminShowParams: 'Show params',
    adminEventParams: 'Event Params',
  },
  'ru': {
    ...
    adminDecline: 'Отклонить',
    adminDelete: 'Удалить',
    adminStatusWaiting: 'Ожидает одобрения',
    adminStatusGranted: 'Доступ разрешён',
    adminTabUsers: 'Пользователи',
    adminTabEvents: 'События',
    adminEventsTitle: 'События',
    adminFilterByUsername: 'Фильтр по пользователю',
    adminFilterByEventType: 'Фильтр по типу события',
    adminFilterFrom: 'С',
    adminFilterTo: 'По',
    adminApply: 'Применить',
    adminReset: 'Сброс',
    adminColTimestamp: 'Время',
    adminColUsername: 'Пользователь',
    adminColEventType: 'Тип события',
    adminColParams: 'Параметры',
    adminShowParams: 'Показать параметры',
    adminEventParams: 'Параметры события',
  },
  'pl': {
    ...
    adminCreatedAt: 'Data',
    adminActions: 'Akcje',
    adminApprove: 'Zatwierdź',
    adminDecline: 'Odrzuć',
    adminDelete: 'Usuń',
    adminStatusWaiting: 'Oczekuje na zatwierdzenie',
    adminStatusGranted: 'Dostęp przyznany',
    adminTabUsers: 'Użytkownicy',
    adminTabEvents: 'Zdarzenia',
    adminEventsTitle: 'Zdarzenia',
    adminFilterByUsername: 'Filtruj po użytkowniku',
    adminFilterByEventType: 'Filtruj po typie zdarzenia',
    adminFilterFrom: 'Od',
    adminFilterTo: 'Do',
    adminApply: 'Zastosuj',
    adminReset: 'Resetuj',
    adminColTimestamp: 'Czas',
    adminColUsername: 'Użytkownik',
    adminColEventType: 'Typ zdarzenia',
    adminColParams: 'Parametry',
    adminShowParams: 'Pokaż parametry',
    adminEventParams: 'Parametry zdarzenia',
  }
}
